...
<script>
    ...
    $(document).ready(function () {
        function counter(){
            var dday = new Date("Sep 11,2021,21:00:00").getTime(); //디데이
...
<div class="contentsWrap">
    <div class="mainImg">
        <div class="characterWrap">
            <div class="mainTitle">
                Series1 close at<br>
                <span>September 11th 12PM (UTC)</span>
                <p class="countDown"></p>
            </div>
            <div class="mainTitle2">
                Series1 closed.<br>
                <span>kmonsterz will return with series 2.<br>
...
<style>
    .soldOut{
        background: url(/static/img/closed.png)rgba(255, 255, 255, 0.7) center no-repeat;
        background-size: 80%;
    }
</style>
</html>
